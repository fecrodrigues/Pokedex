package br.com.creativedevmind.pokedex.data.repository

import br.com.creativedevmind.pokedex.data.remote.api.APIService
import br.com.creativedevmind.pokedex.data.remote.api.PokemonService
import br.com.creativedevmind.pokedex.data.remote.mapper.PokemonPayloadMapper
...
class PokemonRepositoryImpl(
    ...
    override fun pesquisar(
        ...
        pokemonService.pesquisar(id)?.enqueue(object : Callback<PokemonPayload> {
